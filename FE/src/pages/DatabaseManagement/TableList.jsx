      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {tables.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900">Chưa có bảng nào</h3>
            <p className="mt-1 text-sm text-gray-500">Bắt đầu bằng cách tạo bảng đầu tiên của bạn.</p>
            <div className="mt-6">
              <button
                onClick={() => setShowCreateModal(true)}
